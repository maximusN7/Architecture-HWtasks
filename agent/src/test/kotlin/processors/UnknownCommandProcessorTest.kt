...
import org.example.processors.UnknownCommandProcessor
...
class UnknownCommandProcessorTest {
    ...
    fun `WHEN process EXPECT see output`() {
        ...
        val processor = UnknownCommandProcessor()
        ...
        assert(output.contains("Unknown command. To see available commands type command: help"))
    }
}
